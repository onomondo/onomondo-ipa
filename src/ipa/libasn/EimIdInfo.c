...
static const int asn_MAP_EimIdInfo_oms_1[] = { 1 };
static const ber_tlv_tag_t asn_DEF_EimIdInfo_tags_1[] = {
...
asn_SEQUENCE_specifics_t asn_SPC_EimIdInfo_specs_1 = {
	...
	offsetof(struct EimIdInfo, _asn_ctx),
	asn_MAP_EimIdInfo_tag2el_1,
	2,	/* Count of tags in the map */
	asn_MAP_EimIdInfo_oms_1,	/* Optional members */
	1, 0,	/* Root/Additions */
	2,	/* First extension addition */
};
asn_TYPE_descriptor_t asn_DEF_EimIdInfo = {
	"EimIdInfo",
	"EimIdInfo",
	&asn_OP_SEQUENCE,
	asn_DEF_EimIdInfo_tags_1,
	sizeof(asn_DEF_EimIdInfo_tags_1)
		/sizeof(asn_DEF_EimIdInfo_tags_1[0]), /* 1 */
	asn_DEF_EimIdInfo_tags_1,	/* Same as above */
	sizeof(asn_DEF_EimIdInfo_tags_1)
		/sizeof(asn_DEF_EimIdInfo_tags_1[0]), /* 1 */
	{ 0, 0, SEQUENCE_constraint },
	asn_MBR_EimIdInfo_1,
	2,	/* Elements count */
	&asn_SPC_EimIdInfo_specs_1	/* Additional specs */
};
