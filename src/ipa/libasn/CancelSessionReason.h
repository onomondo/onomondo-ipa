...
typedef enum CancelSessionReason {
	...
	CancelSessionReason_metadataMismatch	= 4,
	CancelSessionReason_loadBppExecutionError	= 5,
	CancelSessionReason_undefinedReason	= 127
} e_CancelSessionReason;

/* CancelSessionReason */
typedef long	 CancelSessionReason_t;
