...
static asn_oer_constraints_t asn_OER_type_GetConnectivityParametersResponse_constr_1 CC_NOTUSED = {
	{ 0, 0 },
	-1};
static asn_per_constraints_t asn_PER_type_GetConnectivityParametersResponse_constr_1 CC_NOTUSED = {
	{ APC_CONSTRAINED | APC_EXTENSIBLE,  1,  1,  0,  1 }	/* (0..1,...) */,
	{ APC_UNCONSTRAINED,	-1, -1,  0,  0 },
	0, 0	/* No PER value map */
};
static asn_TYPE_member_t asn_MBR_GetConnectivityParametersResponse_1[] = {
	{ ATF_NOFLAGS, 0, offsetof(struct GetConnectivityParametersResponse, choice.connectivityParameters),
	...
	{ ATF_NOFLAGS, 0, offsetof(struct GetConnectivityParametersResponse, choice.connectivityParametersError),
...
static const asn_TYPE_tag2member_t asn_MAP_GetConnectivityParametersResponse_tag2el_1[] = {
    { (ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0, 0 }, /* connectivityParameters */
    { (ASN_TAG_CLASS_CONTEXT | (1 << 2)), 1, 0, 0 } /* connectivityParametersError */
};
static asn_CHOICE_specifics_t asn_SPC_GetConnectivityParametersResponse_specs_1 = {
...
asn_TYPE_descriptor_t asn_DEF_GetConnectivityParametersResponse = {
	...
	sizeof(asn_DEF_GetConnectivityParametersResponse_tags_1)
		/sizeof(asn_DEF_GetConnectivityParametersResponse_tags_1[0]), /* 1 */
	asn_DEF_GetConnectivityParametersResponse_tags_1,	/* Same as above */
	sizeof(asn_DEF_GetConnectivityParametersResponse_tags_1)
		/sizeof(asn_DEF_GetConnectivityParametersResponse_tags_1[0]), /* 1 */
	{ &asn_OER_type_GetConnectivityParametersResponse_constr_1, &asn_PER_type_GetConnectivityParametersResponse_constr_1, CHOICE_constraint },
	asn_MBR_GetConnectivityParametersResponse_1,
	2,	/* Elements count */
	&asn_SPC_GetConnectivityParametersResponse_specs_1	/* Additional specs */
};
