...
#ifndef	_CompactOtherSignedNotification_H_
#define	_CompactOtherSignedNotification_H_
...
} CompactOtherSignedNotification_t;
...
#endif	/* _CompactOtherSignedNotification_H_ */
